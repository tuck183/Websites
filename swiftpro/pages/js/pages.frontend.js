(function($) {
    ...
    Pages.prototype.initMobileMenu = function() {
            if ($('.mainmenu-area .navigation button').length) {
        $('.mainmenu-area button').on('click', function() {
            $('.mainmenu-area .navigation .nav-header').slideToggle();
            $('.mainmenu-area .navigation .nav-header').find('.dropdown').children('a').append(function() {
                return '<button><img src="assets/images/menu-icon.png" class="img-responsive" width="20px" height="20px" alt="SwiftPro"></button>';
            });
            $('.mainmenu-area .navigation .nav-header .dropdown a button').on('click', function() {
