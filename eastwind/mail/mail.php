...
$outgoingServerAddress      = 'mail.eastwindtl.com'; // Consult your hosting provider.
$outgoingServerPort         = '465';                  // Options: '25, 587' , '25' - Consult your hosting provider.
...
$sendingAccountUsername     = 'noreply@eastwindtl.com';
$sendingAccountPassword     = 'qpP0KS(!KyYj';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'info@eastwindtl.com'; // REQUIRED value.
$recipientName              = 'Tom Alaribe';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Your Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Eastwind';                // REQUIRED value. This is used when a name or email is not collected from the website form
